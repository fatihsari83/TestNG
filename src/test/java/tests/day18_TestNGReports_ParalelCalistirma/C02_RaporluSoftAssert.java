...
public class C02_RaporluSoftAssert extends TestBaseRapor {
    ...
    public void test01() throws InterruptedException {
        ...
        softAssert.assertEquals(actualAlertYazisi,expectedAlertYazisi,"alertteki belirlenenden farkli");
        extentTest.info("Softassert ile alert yazisinin beklenen degere sahip oldugunu test eder");


        //            -  OK tusuna basip alert'i kapatin
        Driver.getDriver().switchTo().alert().accept();
        extentTest.info("alert i kapatır");
        ...
        extentTest.info("softassert ile alertin kapatıldıgını test eder");

        softAssert.assertAll();
        extentTest.pass("sosftassert ile yapilan tum testlerin sonucunu raporlar");
        Driver.closeDriver();
